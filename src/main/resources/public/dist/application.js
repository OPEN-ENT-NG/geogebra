...
/***/ (function(module, exports, __webpack_require__) {
	...
	/**
	    ...
	    Main controller.
	**/
	exports.mainController = entcore_1.ng.controller('MainController', ['$scope', 'route', function ($scope, route) {
	                ...
	                switch (_a.label) {
	                    case 0:
	                        if (!($scope.data.documentSelected && $scope.data.documentSelected.metadata && $scope.data.documentSelected.metadata.extension &&
	                            $scope.data.documentSelected.metadata.extension == "ggb")) return [3 /*break*/, 5];
	                        _a.label = 1;
	                    case 1:
	                        _a.trys.push([1, 3, , 4]);
	                        idFile = $scope.data.documentSelected._id;
	                        return [4 /*yield*/, axios_1.default.get("geogebra/document/" + idFile)];
	                    case 2:
	                        file = _a.sent();
	                        // @ts-ignore
	                        ggbApplet.setBase64(file.data.base64File);
	                        entcore_1.notify.success("fichier geogebra bien intégré à l'appli");
	                        return [3 /*break*/, 4];
	                    case 3:
	                        e_1 = _a.sent();
	                        entcore_1.notify.error(e_1.error);
	                        throw (e_1);
	        ...
	        $scope.saveGGB = function (name) { return __awaiter(_this, void 0, void 0, function () {
	            ...
	            return __generator(this, function (_a) {
	                switch (_a.label) {
	                    ...
	                    case 2:
	                        e_2 = _a.sent();
	                        entcore_1.notify.error(e_2.error);
	                        throw (e_2);
	                    case 3: return [2 /*return*/];
	                }
	            });
	        }); };
	        $scope.openMediaLibrary = function () { return __awaiter(_this, void 0, void 0, function () {
	            return __generator(this, function (_a) {
	                switch (_a.label) {
	                    case 0:
...
/***/ (function(module, exports) {
	...
	var Utils = /** @class */ (function () {
	    ...
	    Utils.safeApply = function (that) {
	        return new Promise(function (resolve) {
	            var phase = (that.$root !== null) ? that.$root.$$phase : undefined;
